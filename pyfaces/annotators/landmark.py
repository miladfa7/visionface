...
class FaceLandmarkAnnotator(BaseLandmarkAnnotator):
    ...
    Example:
        >>> from pyfaces.models.landmark_detection.Dlib import DlibFaceLandmarkDetector
        >>> from pyfaces.annotators.landmark import FaceLandmarkAnnotator
        >>> from pyfaces.annotators.helper.landmark_connections import DLIB_FACE_LANDMARK_CONNECTIONS
        >>> 
